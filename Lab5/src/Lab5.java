...
// FILENAME: Lab5.java
// SPECIFICATION: User is prompted to enter the data required for 
 * a student and a program. Then a student and program is created 
 * and their status is printed. The makeReport method reports all 
 * of the data reported for the student and program.
// FOR: CS 1400- Lab #5
// TIME SPENT: 15 min.
//-----------------------------------------------------------*/
...
public class Lab5 {
    ...
    /**
     * prints the submission details of the student and the program
     * @param program1
     */
