...
// FILENAME: Lab2.java
// SPECIFICATION: The user to enter two strings, firstName and 
lastName, and concatenates the strings to make a full name. 
Then it prints the full name and length.
 Next it compares two strings using == and the .equals() method 
// FOR: CS 1400 - Lab #2
// TIME SPENT: 15 min.
*/
